...
const Carousel1 = () => {
  ...
  return (
    <div className="carousel-container">
      <button className="carousel-left-btn" onClick={scrollLeft}>
        <ChevronLeft width={50} height={50} />
      </button>
      <div className="carousel-content-container" ref={carouselRef}>
      ...
      <button className="carousel-right-btn" onClick={scrollRight}>
